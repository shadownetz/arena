$(function(){
    ...
    let restaurant_ref_id = $('#js-restaurant-ref-id').val();
    let restaurant_id = $('#js-restaurant-id').val();
    let page_position = $('#js-restaurant-page-pos').val();
    let restaurant_modify_url = $('#js-restaurant-modify-url').val() + '?center='+restaurant_ref_id+'&id='+restaurant_id+'&pos='+page_position;
    $('#addEventForm').attr('action', restaurant_modify_url.toString());
});
